        ...
        <div className='
          w-full flex justify-between items-center max-w-7xl mx-auto'>
            ...
            >
              ...
              <p className='text-white text-[18px] font-bold cursor-pointer flex'>Mohamed Dhia &nbsp;
              <span className='sm:block hidden'>| Senior Full Stack Engineer</span></p>
            </Link>
                ...
                <ul className='list-none flex justify-end items-start flex-col gap-4'>
                  {navLinks.map( nav => (
                    ...
                    className={`${active  === nav.title 
                      ? " text-white"
                      : "text-secondary"
                    } font-poppins font-medium cursor-pointer text-[16ox]`}
                    onClick={ () => { 
                      setToggle(!toggle)
                      setActive(nav.title)
                    }}>
